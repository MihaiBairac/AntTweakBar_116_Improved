...
// Event handling in SDL 2.0.9 has been changed compared to the SDL1.x versions.
...
int TW_CALL TwEventSDL20(const void *sdlEvent)
{
    ...
    case SDL_WINDOWEVENT:
		if (event->window.event == SDL_WINDOWEVENT_RESIZED)
		{
			...
			// do not set 'handled', SDL_WINDOWEVENT may be also processed by the calling application
		}
        break;
    }
